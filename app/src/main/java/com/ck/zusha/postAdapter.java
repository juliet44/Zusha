...
public class postAdapter extends RecyclerView.Adapter<postAdapter.postviewHolder> {
    ...
    public void onBindViewHolder(@NonNull postviewHolder holder, int position) {
            ...
            final String postId= postCurrent.getPostId();

            holder.textViewDescription.setText(postCurrent.getDescription());

            if(postCurrent.getImagedownloadURI()!=null) {
                GlideApp.with(mContext)
                        .load(postCurrent.getImagedownloadURI())
